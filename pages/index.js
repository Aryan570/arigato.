...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Arigato.com - Wear the jerseys</title>
        <meta name="description" content="Arigato.com - Wear the jerseys" />
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear the Jerseys with Arigato.com</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear the jerseys of Cristiano Ronaldo , Lionel Messi , Neymar Jr. and many more.</p>
    </div>
