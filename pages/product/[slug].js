      ...
      <div className="container px-5 py-16 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">ARIGATO</h2>
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex">
                ...
                {Object.keys(variants).includes('yellow') && Object.keys(variants['yelow']).includes(size) && <button onClick={() => { refreshVariant(size, 'yellow') }} className={`border-2 ml-1 bg-yellow-500 rounded-full w-6 h-6 focus:outline-none ${color == 'yellow' ? 'border-black' : 'border-gray-300'}`}></button>}
              </div>
            ...
            <div className="flex">
              ...
              <button disabled={product.availableQty <= 0} onClick={() => { buyNow(slug, 1, product.price, product.title, size, color) }} className="flex ml-8 {//could do ml-auto} text-white bg-cyan-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-cyan-600 rounded disabled:bg-cyan-300">Buy Now</button>
              <button disabled={product.availableQty <= 0} onClick={() => { addToCart(slug, 1, product.price, product.title, size, color) }} className="flex ml-4 {//could do ml-auto} text-white bg-cyan-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-cyan-600 rounded disabled:bg-cyan-300">Add to Cart</button>
            ...
            <div className="pin mt-6 flex space-x-2">
              ...
              <button onClick={checkServiceability} className='text-white bg-cyan-500 border-0 py-2 px-6 focus:outline-none hover:bg-cyan-600 rounded'>Check</button>
            </div>
...
export async function getServerSideProps(context) {
  ...
  let colorSizeSlug = {} // {blue:{XL:{slug:'wear-the-jersey-XL'}}}
